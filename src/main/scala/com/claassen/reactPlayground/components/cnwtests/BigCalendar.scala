...
object BigCalendar {
  ...
  class Backend($: BackendScope[Props, State]) {
    ...
    def updateView(s: State): Callback = $.setState(s)
    ...
    val component = ScalaComponent.builder[Props]("Calendar")
      .initialState(State(""))
      .renderBackend[Backend]
      .componentDidMount(_.backend.start)
      .build
//  val component = ScalaComponent.builder[Unit]("BC")
//    .render(
//      <.div(
//        BigCalendarWrapper()()
//      )
...
case class BigCalendarWrapper(
                               ...
                               /**
                                 ...
                                 * ```
                                 */
                               events: js.UndefOr[Array[js.Object]] = js.undefined,
                               ...
                               /**
                                 ...
                                 */
                               resources: js.UndefOr[Array[js.Object]] = js.undefined,
